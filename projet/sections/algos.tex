...
$\mathcal{O}(|E_1| \log(|E_1|))$, ce qui pourrait être amélioré sans la fonction
...
Pour le problème du plus court chemin, c'est plus compliqué.
...
On pose le programme linéaire suivant, équivalent à trouver le problème de plus
court chemin:
...
\begin{question*}[subsidiaire]
  Proposer des algorithmes alternatifs pour calculer les chemins minimaux sans
  passer par la transformation de graphe.
\end{question*}
